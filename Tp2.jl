...
# ╔═╡ 481d9ec5-5310-488e-a76e-0607c3a228cc
function transformada_inv(matriz)
	for i in 1:div(size(matriz)[1], 8) 
		for j in 1:div(size(matriz)[2], 8)
			vista = view(matriz, 8*(i-1)+1:8*i, 8*(j-1)+1:8*j)
			idct!(vista)
...
begin
a=copy(descomponer(imagen1))
b=copy(descomponer(imagen1))
end;

# ╔═╡ c8d1c24d-5490-4a51-933a-a5db3afba7e8
a[3][123, 390]

# ╔═╡ 2873ca85-7826-4da5-a348-cd4c756c888b
transformada_por_bloques(b);
