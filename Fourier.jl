...
# ╔═╡ 0f6bd3d2-6dc2-11ee-243c-bbbe9b86821e
using Plots, WAV

# ╔═╡ 5ad977f0-79d8-4382-bd72-5b15c15de02b
md""" Integracion numerica """

# ╔═╡ 811cdef9-f906-4b5c-8906-098fa79129ea
md"""$I_{a}^{b} f = \sum_{i=0}^{N-1}I_{x_{i}}^{x_{i+1}}f$"""

# ╔═╡ cda4bbec-de78-438d-b467-a21b59275eb3
md"""$\sum_{i=0}^{N-1}(x_{i+1}-x_i)\frac{f(x_i)-f(x_{i+1})}{2}$"""

# ╔═╡ 29be44ba-eba5-4253-8c1b-82895d4b3e62
md"""$h[\frac{f(a)}{2}+\sum_{i=1}^{N-1}f(x_i)+\frac{f(b)}{2}]$"""

# ╔═╡ 57d671c1-2202-4539-a584-29c8f05a4ff0
function integracionTrapC(f,a,b,h)
	xs = a:h:b
	#println(f(xs))
	res1 = 0 
	for x in xs 
	...
	return h*(-(f(a)/2) + res1 -(f(b)/2))
end

# ╔═╡ 73b522cd-54a3-43ef-89f5-de8ae603643e
md"""Ejercicio 7"""

# ╔═╡ d0e5bf8b-f09a-4025-b64e-b663192942d1
function D(N,t)
	res = sin((N+1/2)*t) / (2*sin(t/2))
	return res
end 

# ╔═╡ 27377644-2291-43cd-a145-10f7c311ca64
begin 
	function g(t) 
		return D(1,t)
	end
	integracionTrapC(g,-pi,pi,0.001)
end

# ╔═╡ 507b47a0-2028-4fd9-9c75-8ac5dcc52691
md"""Ejercicio 8"""
